          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
            <tr>
              <td style="vertical-align:middle;padding-right:10px;">
                <img src="${process.env.NEXT_PUBLIC_APP_URL ?? 'https://app.salden.xyz'}/logo.svg" alt="Salden" width="36" height="36" style="display:block;">
              </td>
              <td style="vertical-align:middle;font-size:18px;font-weight:800;letter-spacing:0.08em;color:#4F46E5;">SALDEN</td>
            </tr>
          </table>
